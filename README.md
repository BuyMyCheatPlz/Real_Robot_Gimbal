...
- S1 三档控制 M2006 拨弹（电机轴带 1:36 减速箱，按输出轴角度闭环）：
  1 保持、2 单发转 40°、3 连发（40°/次，20 Hz）。
...
| S1=2 | M2006 单发一次：输出轴转 40° 后保持 |
| S1=3 | M2006 连发：每 50 ms 步进 40°（20 Hz） |
...
| 通道 | 功能 |
|---|---|
| S1 | M2006 拨弹步进：1 保持，2 单发转 40°，3 连发(20 Hz×40°) |
...
- S1=2 单发步进 40°，S1=3 每 50 ms 步进 40°；
