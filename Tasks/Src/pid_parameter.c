...
static const PidParameterName_t parameter_names[] = {
    ...
    {"C1_GR", PID_PARAM_PITCH_GRAVITY_C1},
    {"PITCH_GRAVITY_C1_GR", PID_PARAM_PITCH_GRAVITY_C1},
    {"PITCH_TRAJ_SPEED", PID_PARAM_PITCH_TRAJ_SPEED},
    {"PITCH_TRAJ_ACCEL", PID_PARAM_PITCH_TRAJ_ACCEL},
    {"PITCH_MAX_SPEED", PID_PARAM_PITCH_MAX_SPEED}
};
