...
int main(void)
{
    ...
    assert(VOFA_YAW_TUNING_MODE == 1U);
    ...
    assert(PITCH_ENCODER_LPF_ALPHA == 1.0f);
    ...
    assert(PITCH_NEAR_TARGET_SPEED_CLAMP_ENABLE == 0U);
    ...
    assert(PITCH_STATIC_ERROR_COMP_DEADBAND_DEG == 0.08f);
    ...
    assert(PITCH_STATIC_ERROR_COMP_LOW_ANGLE_TARGET_MAX_DEG == -45.0f);
    assert(PITCH_STATIC_ERROR_COMP_LOW_ANGLE_VOLT_PER_DEG == 5000.0f);
    assert(PITCH_STATIC_ERROR_COMP_LOW_ANGLE_LIMIT == 1000.0f);
    assert(PITCH_STATIC_ERROR_COMP_SLEW_VOLT_PER_S == 40000.0f);
    ...
    assert(PITCH_APPROACH_DOWN_BRAKE_DELAY_S == 0.030f);
    assert(PITCH_APPROACH_LOW_TARGET_DOWN_BRAKE_DELAY_S == 0.030f);
    assert(PITCH_APPROACH_LOW_ANGLE_UP_BRAKE_DELAY_S == 0.030f);
    assert(PITCH_APPROACH_HIGH_ANGLE_UP_ACCEL_SCALE == 2.00f);
    assert(PITCH_APPROACH_HIGH_ANGLE_UP_BRAKE_DELAY_S == 0.055f);
    assert(PITCH_APPROACH_BRAKE_FF_ENABLE == 0U);
    ...
    assert(LAUNCH_M2006_ID5_SPEED_KP == 35.0f);
    assert(LAUNCH_M2006_ID5_SPEED_KI == 2.0f);
    assert(LAUNCH_M2006_ID5_INTEGRAL_LIMIT == 1500.0f);
    assert(LAUNCH_M2006_ID5_OUTPUT_LIMIT == 8000.0f);
    assert(LAUNCH_M2006_ID5_SPEED_LPF_ALPHA == 0.50f);
    assert(LAUNCH_M2006_ID5_CONT_PLL_KP_RPM_PER_DEG == 45.0f);
    assert(LAUNCH_M2006_ID5_ANGLE_KP_RPM_PER_DEG == 80.0f);
    assert(LAUNCH_M2006_ID5_ANGLE_MAX_SPEED_RPM == 3200.0f);
    assert(LAUNCH_M2006_ID5_ANGLE_MAX_SPEED_RPM_CONT == 4900.0f);
    assert(LAUNCH_M2006_ID5_ANGLE_DEADBAND_DEG == 2.5f);
    assert(M2006_STOP_DEADBAND_RPM == 15.0f);
